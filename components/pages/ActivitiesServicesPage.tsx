...
interface ActivitiesServicesPageProps {
  locale: string;
}
...
function DetailsList({
  ...
  const rows = [
    ...
    { icon: faTag, label: details.price, show: true },
...
export default async function ActivitiesServicesPage({
  locale,
}: ActivitiesServicesPageProps) {
